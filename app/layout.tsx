...
export const metadata: Metadata = {
  ...
  openGraph: { title: "ProConnect — Your expertise. One powerful tap.", description: "Meet the $19 ProConnect digital business card for the tax community.", type: "website", images: [{ url: "/proconnect-logo.jpg", width: 1800, height: 900, alt: "ProConnect digital business card by Tax Compliance Pro" }] },
  twitter: { card: "summary_large_image", title: "ProConnect | Tax Compliance Pro", description: "One card. One profile. More ways to grow—for $19 one time.", images: ["/proconnect-logo.jpg"] },
};
